    ...
    >
      ...
      >
        ...
        {loadStage !== 'READY' && loadStage !== 'FAILED' && (
          <div className="absolute inset-0 bg-[#FFFFFF]/95 flex flex-col items-center justify-center text-xs text-[#1C1C1C] gap-2.5 z-10 select-none pointer-events-none">
        ...
        {loadStage === 'FAILED' && (
          <div
            data-testid="structure-load-failed-overlay"
